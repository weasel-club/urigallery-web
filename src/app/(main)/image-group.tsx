          ...
          return (
            <div
              ...
              className={cn(
                ...
                isToday
                  ? "size-[calc(100%/4-0.5rem/4*3)] max-sm:size-[calc(100%/3-0.5rem/3*2)] aspect-square"
                  : "size-[calc(100%/5-0.5rem/5*4)] max-sm:size-[calc(100%/4-0.5rem/4*3)] aspect-square"
              )}
            >
              <Img
                path={image.path}
                name={image.name}
                size={isToday ? 750 : 450}
